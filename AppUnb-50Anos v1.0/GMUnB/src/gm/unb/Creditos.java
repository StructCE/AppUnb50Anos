...
public class Creditos extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Botão do Face
        ImageButton btface = (ImageButton) findViewById(R.id.menu_bt_face);
        ...
        //Botão do Twitter
        ImageButton btunb = (ImageButton) findViewById(R.id.menu_bt_twit);
    ...
    {  
        ...
        {  
            ...
            finish();
        	this.startActivity(new Intent(Creditos.this,MainMenu.class));
